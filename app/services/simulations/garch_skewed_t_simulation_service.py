...
def run_garch_skewed_t_simulation(symbol: str, num_simulations: int = 10000, num_days: int = 252, include_chart_data: bool = False):
    """
    GARCH(1,1) with Skewed Student's t distribution simulation.
    ...
    # Use skew-normal as approximation
