...
def run_gjr_garch_n_simulation(symbol: str, num_simulations: int = 10000, num_days: int = 252, include_chart_data: bool = False):
    """
    GJR-GARCH(1,1) with Normal distribution simulation.
    ...
    # Fit GJR-GARCH(1,1,1) with Normal distribution
