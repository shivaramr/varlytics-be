...
def run_e_garch_skewed_n_simulation(symbol: str, num_simulations: int = 10000, num_days: int = 252, include_chart_data: bool = False):
    """
    EGARCH(1,1) with Skewed Normal distribution simulation.
    ...
    # Fit EGARCH(1,1) with Skewed Normal distribution
