...
def run_gjr_garch_skewed_ged_simulation(symbol: str, num_simulations: int = 10000, num_days: int = 252, include_chart_data: bool = False):
    """
    GJR-GARCH(1,1) with Skewed GED distribution simulation.
    ...
    # Fit GJR-GARCH(1,1,1) with Skewed GED distribution
    ...
    shocks = skewnorm.rvs(-1.5, size=(num_days, num_simulations))
